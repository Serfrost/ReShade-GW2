...
#ifdef WIN64
		LOG(INFO) << "Initializing Serfrost's ReShade-MOD '" VERSION_STRING_FILE "' (64-bit) loaded from " << g_reshade_dll_path << " into " << g_target_executable_path << " ...";
#else
		LOG(INFO) << "Initializing Serfrost's ReShade-MOD '" VERSION_STRING_FILE "' (32-bit) loaded from " << g_reshade_dll_path << " into " << g_target_executable_path << " ...";
#endif
