...
#ifdef WIN64
		LOG(INFO) << "Initializing Serfrost's ReShade-MOD 4.5.4-r4 (64-bit) loaded from " << g_reshade_dll_path << " into " << g_target_executable_path << " ...";
#else
		LOG(INFO) << "Initializing Serfrost's ReShade-MOD 4.5.4-r4 (32-bit) loaded from " << g_reshade_dll_path << " into " << g_target_executable_path << " ...";
#endif
